...
class LLMClient:
    ...
    def _mock_response(self, messages: List[Dict[str, str]]) -> str:
        ...
        if "router" in last_lower or "classify" in last_lower:
            if any(word in last_lower for word in ["plot", "chart", "graph", "visualize", "show me a"]):
                return "VISUALIZATION"
            elif any(word in last_lower for word in ["how many", "total", "sum", "average", "count", "what is", "show me"]):
                return "DATA_QUERY"
            else:
                return "GENERAL"
        ...
        if "python" in last_lower or "plotly" in last_lower or "visualization" in last_lower or "chart" in last_lower:
...
"""
    ...
    def _generate_mock_general(self, query: str) -> str:
        ...
        q = query.lower()
        if "north" in q:
            return ("The North region includes New York (NY), New Jersey (NJ), and Connecticut (CT). "
            ...
            return ("Enterprise customers are defined as those with more than 500 employees. "
            ...
            return ("I can help you analyze sales data, customer segments, and regional performance. "
